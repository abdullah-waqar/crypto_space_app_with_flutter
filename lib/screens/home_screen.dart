...
import 'package:crypto_space/utilities/costants.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // We will fetch the data as soon as app get initilized
  @override
  void initState() {
    super.initState();
    _fetchCryptos();
  ...
  Icon _getPrefixIcon(double percentChange, {Color? color}) {
    return percentChange <= 0
        ? Icon(Icons.arrow_drop_down_rounded,
            size: 32, color: color ?? kRedColor)
        : Icon(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: kBlackColor,
        centerTitle: false,
        // Adding little border under the appbar
